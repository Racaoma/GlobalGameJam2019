...
public class Enemy_Puff : Enemy
{
    ...
    private void move(float targetMovementSpeed)
    {
        ...
        characterControllerRef.move(movementDirection * targetMovementSpeed);
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            if (collision != null) move(movementSpeed * 4);
            else move(movementSpeed);
        }
    }
}
